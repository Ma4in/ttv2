        ...
        <div class="container">
            <div class="row">
                <div class="col mx-5 my-3">
                    ...
                    <p><button type="button" class="btn" data-bs-toggle="popover" data-bs-placement="right" data-bs-custom-class="custom-popover" data-bs-content="Офис :
                        example@tamga.ru 
                        Поддержка :
                        support_example@tamga.ru">
                            Почта
                        </button></p>
                    <p><button type="button" class="btn" data-bs-toggle="popover" data-bs-placement="right" data-bs-custom-class="custom-popover" data-bs-content="Основной :
                        +7 999-999-99-99
                        Резервный :
                        +7 999-999-99-99">
                            Телефон
                ...
                <div class="col mx-5 my-3">
                    ...
                    <a href="" download="">
                        <button type="button" class="btn btn-light text-left">
                            <div class="row">
                                <div class="col">
                                    <p class="mb-1 col">Скачать<br>приложение</p>
                                </div>
